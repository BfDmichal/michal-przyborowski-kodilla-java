...
public class BoardTestSuite {
    ...
    public void testToString(){
        //Given
        // creating the TaskList for todo
        TasksList listToDo = new TasksList("To Do Tasks");
        IntStream.iterate(1, n -> n+1)
                .limit(10)
                .forEach(n-> listToDo.getTasks().add(new Task("Task to do list number: "+n)));
        ...
        //making a deep clone of objet board
        ...
        Assert.assertEquals(clonedBoard.getLists(),clonedBoard.getLists());
